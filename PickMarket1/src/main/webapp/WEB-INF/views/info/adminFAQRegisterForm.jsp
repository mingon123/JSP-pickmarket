...
<div id="admin-edit" class="page-main">
	...
	<div class="content-main">
		<h2>FAQ 등록</h2>
		<form id="register_form" action="adminFAQRegister.do" method="post">
			<ul>
				<li>
					<label for="faq_title">제목</label>
					<input type="text" name="faq_title" id="faq_title" maxlength="100" class="input-check" autocomplete="off" >
				</li>
				<li>
					<label for="faq_content">내용</label>
					<textarea rows="6" cols="40" name="faq_content" id="faq_content" class="input-check" autocomplete="off"></textarea>
				</li>
			</ul> 
