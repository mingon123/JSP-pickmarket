...
<div id="admin-edit" class="page-main">
	...
	<div class="content-main">
		<h2>운영정책 등록</h2>
		<form id="register_form" action="adminOPRegister.do" method="post">
			<ul>
				<li>
					<label for="pol_title">제목</label>
					<input type="text" name="pol_title" id="pol_title" maxlength="100" class="input-check" autocomplete="off" >
				</li>
				<li>
					<label for="pol_content">내용</label>
					<textarea rows="6" cols="40" name="pol_content" id="pol_content" class="input-check" autocomplete="off"></textarea>
				</li>
			</ul> 
