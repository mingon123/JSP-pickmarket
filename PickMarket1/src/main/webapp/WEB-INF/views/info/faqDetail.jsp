...
<div class="page-main">
	...
	<div class="content-main">
		<h3><b>자주 묻는 질문</b></h3><br>
		<div class="info-header">
		  	<span class="notice-title">${faq.faq_title}</span>
		</div>
		<p class="info-content">${faq.faq_content}</p>
		...
		<div class="list-space align-right">
			...
			<script type="text/javascript">
				...
				delete_btn.onclick=function(){
					...
					if (choice) {
						location.replace('adminFAQDelete.do?faq_num=${faq.faq_num}');
					}
				};
			</script>
			</c:if>
