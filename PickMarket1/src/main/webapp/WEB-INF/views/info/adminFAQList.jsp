...
<div class="page-main">
	...
	<div class="content-main">
		<h2>FAQ 관리</h2>
		<form id="search_form" action="adminFAQList.do" method="get">
			<ul class="search">
				<li>
				...
				<li>
					<input type="button" value="초기화" onclick="location.href='adminFAQList.do'">
				</li>
			</ul>
		</form>
		...
		<table>
			...
			<tr>
				<td>${faq.faq_num}</td>
				<td>
					<a href="adminFAQDetail.do?faq_num=${faq.faq_num}">${faq.faq_title}</a>
				</td>
				<td>
		...
		<div class="list-space align-right">
			...
			<input type="button" value="등록" onclick="location.href='${pageContext.request.contextPath}/info/adminFAQRegisterForm.do'">
