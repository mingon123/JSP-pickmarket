...
public class AdminBlockDeleteAction implements Action{
	@Override
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// 회원정보 삭제
		dao.deleteBlockByAdmin(blocker_num,blocked_num);
		
		request.setAttribute("notice_msg", "삭제가 완료되었습니다.");
		request.setAttribute("notice_url", request.getContextPath()+"/block/adminBlockList.do");
